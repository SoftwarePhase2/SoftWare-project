					...
					while(true)
					{
						...
						else if(openPro.equals("1"))
						{
							...
							if(AppCalculations.calculatePriceForAllProducts(idCustomer)>400)
							{
								...
								LOGGER.info("The old price is: ");
								LOGGER.info(AppCalculations.calculatePrice(height, width, catogery).toString());
								LOGGER.info("The new price is: ");
								LOGGER.info(AppCalculations.calculatePriceWithDiscount(height, width, catogery).toString());
							}
							else
							{
